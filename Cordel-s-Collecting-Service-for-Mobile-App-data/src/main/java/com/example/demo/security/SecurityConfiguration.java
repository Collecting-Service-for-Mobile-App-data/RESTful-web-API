...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain configureAuthorizationFilterChain(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                ...
                .requestMatchers("/api/user/company/").hasRole("ROLE_ADMIN")
                .requestMatchers("/api/sqlite-files/company/").hasRole("ROLE_ADMIN")
                .requestMatchers("/api/sqlite-files/all").hasRole("ROLE_ADMIN")
                .requestMatchers("/api/sqlite-files/").hasAnyRole("ROLE_USER","ROLE_ADMIN")
                .requestMatchers("/api/role/all").hasRole("ROLE_ADMIN")
                .requestMatchers("/api/company/companies").hasRole("ROLE_ADMIN")
